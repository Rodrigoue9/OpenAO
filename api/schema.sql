...
-- Floor objects carry objIndex + amount and therefore cannot be represented
-- as graphic layers without losing gameplay data.
...
-- Doors keep visual and collision state separately from structure layers so
-- neither feature can silently overwrite the other.
